...
import 'package:tdd_demo/repository_interface/local_user_repository.dart';
...
void main() {
  test('Get User test (Success)', () async {
    ...
    when(dio.get('https://reqres.in/users/2')).thenAnswer((_) async {
      return Future.value(Response<dynamic>(
          ...
          statusCode: 200,
          requestOptions: RequestOptions(path: 'https://reqres.in/users/2')));
    });
  ...
  test('Get User test (Failure)', () async {
    ...
    when(dio.get('https://reqres.in/users/23')).thenAnswer((_) async {
      return Future.value(Response<dynamic>(
          data: {},
          statusCode: 404,
          requestOptions: RequestOptions(path: 'https://reqres.in/users/23')));
    });
